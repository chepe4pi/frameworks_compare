...
async def get_order(order_id: int):
    ...
    order_row, products_rows = await asyncio.gather(
        database.fetch_one(query=order_query, values={"order_id": order_id}),
        database.fetch_all(query=products_query, values={"order_id": order_id})
    )
